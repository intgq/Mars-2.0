...
## 
## Makefile     : test.mk
## Generated on : Wed Nov 02 23:12:59 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test
...
START_DIR                 = /Users/bearhero/Projects/mars/Examples/AADL/CCS/Simulink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/test_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/test_ert_rtw/test.c
