...
if __name__ == "__main__":
    ...
    argparser.add_argument('-jf','--jsonfile',type=str,default = "Examples/AADL/CCS/AADL/joint_model_nobus.json",help="directory of json file")
    argparser.add_argument('-od','--outputdir',type=str,default = "Examples/AADL/CCS/TCS/generatedcode_nobus",help="directory (folder) of output hcsp file")
